...
//
// Like C, Swift provides compound assignment operators that combine assignment (=) with another
// operation. One example is the addition assignment operator (+=)
...
//
// Note : The compound assignment operators don't return a value. For example, you can't write 
// let b = a += 2.
//
