...
let binaryInterger = 0b10001 // 17 in binary notation
let ocatalInterger = 0o21 // 17 in octal notation
...
// Decimal floats can also have an optionla exponent, indicated by an uppercase or lowercase e;
// hexadecimal floats must have an exponent, indicated by an uppercase or lowecase p.
//
...
let exponentDouble = 1.2875e1
let hexadecimalDouble = 0xC.3p0

// Numeric literals can contain extra formatting to make them easier to read. Both integers and
// floats can be padded with extra zeros and can contain underscores to help with readability.
