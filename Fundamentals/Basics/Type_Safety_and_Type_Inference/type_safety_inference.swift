...
// of values your code can work with. If part of you code requires a String, you can't pass it an 
// Int by mistake.
//
// Because Swift is type safe, it performs type checks when compiling your code and flags any
// mismatched types as errors. This enables you to catch and fix errors as earyl as possible
// in the development process.
//
// Type-checking helps you avoid errors when you're working with different type of values.
// However, this doesn't mean that you have to specify the type of every constant and variable
// that you declare. If you don't specify the type of value you need, Swift uses type inference
// to work out the appropriate type. Type inference enables a compiler to deduce the type of
// a particular expression automatically when it compiles your code, simply by examining the values
// you provide.
//
...
// value. This is often done by assigning a literal value (or literal) to the constant or variable
// at the point that you declare it. (A literal value is a value that appears directly in your
// source code, such as 42 and 3.14159 in the examples below).
//
// For example, if you assign a literal value of 42 to a new constant without saying what type it is,
// Swift infers that you want the contatn to be an Int, because you have initialized it with a
...
// The literal value of 3 has no explicit type in and or itself, and so an appropriate output type
